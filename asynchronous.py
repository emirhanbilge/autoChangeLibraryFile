...
class ModbusTcpProtocol(protocol.Protocol):
    ...
    def connectionMade(self):
        ...
        ..note:: since the protocol factory cannot be accessed from the
                 ...
                 our __init__ method.
        """
        #print("Buradaaa " , self.transport.getHost())
        
        import modbusManage as mdbs
        mdbs.clientConnect()
    ...
    def connectionLost(self, reason):
        ...
        """
        print("Bağlantı koptu hata sebebi : " , reason)
        import modbusManage as mdbs
        mdbs.clientDisconnect()
    ...
    def _execute(self, request):
        ...
        try:
            ...
            #print("Bağlantı ID : " ,request.unit_id)
